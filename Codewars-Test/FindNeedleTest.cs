...
namespace Codewars.Test
{
    ...
    public class FindNeedleTest
    {
        ...
        public void GenericTests()
        {
            ...
            Assert.AreEqual("found the needle at position 3", FindNeedle.Solution(haystack_1));
            Assert.AreEqual("found the needle at position 5", FindNeedle.Solution(haystack_2));
            Assert.AreEqual("found the needle at position 30", FindNeedle.Solution(haystack_3));
        }
    }   
}